...
class PhpSerial
{
    ...
    {
//		echo "This is the begining serial portdiscovery: ", $device, "\n";  //pat  what is the device
//		echo "state ", $this->_dState, "\n";                                //pat what state is it in?
...
//					echo "Linux Device: ", $device, "\n";
            ...
            } elseif (PHP_OS_FAMILY === "osx") {
                if ($this->_exec("stty -f " . $device) === 0) {
                    $this->_device = $device;
                    $this->_dState = SERIAL_DEVICE_SET;
//				echo "This is OSX section","\n";
                    return true;
                }
                ...
                if (preg_match("@^COM(\\d+):?$@i", $device, $matches)
                    ...
                    $this->_dState = SERIAL_DEVICE_SET;
//					echo "This is Windows section","\n";
                    return true;
                }
            }
//			echo "This is the serial port: ", $device, "\n";  //pat
...
//	echo "INT: ", $int, "\n";
    ...
    public function confStopBits($length)
    {
        ...
        if ($length != 1
                and $length != 2
                and $length != 1.5
                and !($length == 1.5 and PHP_OS_FAMILY === "Linux")
        ) {
            trigger_error(
 ...
 //       echo "STR: ", $str, "\n";
    ...
    public function readPort($count = 0)
    {
        ...
        if (PHP_OS_FAMILY === "Linux" || PHP_OS_FAMILY === "osx") {
